...
"}")
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.user_infoframe)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1219, 551))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.demande = QtWidgets.QFrame(self.scrollAreaWidgetContents)
        self.demande.setGeometry(QtCore.QRect(10, 20, 241, 181))
        self.demande.setStyleSheet("background-color: rgb(132, 132, 132);")
        self.demande.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.demande.setFrameShadow(QtWidgets.QFrame.Raised)
        self.demande.setObjectName("demande")
        self.nomdemadeur = QtWidgets.QLabel(self.demande)
        self.nomdemadeur.setGeometry(QtCore.QRect(0, 10, 241, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.nomdemadeur.setFont(font)
        self.nomdemadeur.setAlignment(QtCore.Qt.AlignCenter)
        self.nomdemadeur.setObjectName("nomdemadeur")
        self.pushButton = QtWidgets.QPushButton(self.demande)
        self.pushButton.setGeometry(QtCore.QRect(20, 122, 71, 41))
        self.pushButton.setStyleSheet("background-color: rgb(170, 0, 0);")
        self.pushButton.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/lenovo/Desktop/tp python/views/icons/x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon5)
        self.pushButton.setIconSize(QtCore.QSize(40, 40))
        self.pushButton.setObjectName("pushButton")
        self.accepter = QtWidgets.QPushButton(self.demande)
        self.accepter.setGeometry(QtCore.QRect(140, 120, 71, 41))
        self.accepter.setStyleSheet("background-color: rgb(0, 170, 0);")
        self.accepter.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/Users/lenovo/Desktop/tp python/views/icons/check.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.accepter.setIcon(icon6)
        self.accepter.setIconSize(QtCore.QSize(50, 50))
        self.accepter.setObjectName("accepter")
        self.label_3 = QtWidgets.QLabel(self.demande)
        ...
        self.refuser = QtWidgets.QLabel(self.demande)
        self.refuser.setGeometry(QtCore.QRect(0, 90, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.refuser.setFont(font)
        self.refuser.setAlignment(QtCore.Qt.AlignCenter)
        self.refuser.setObjectName("refuser")
        self.datefin = QtWidgets.QLabel(self.demande)
        self.datefin.setGeometry(QtCore.QRect(110, 90, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.datefin.setFont(font)
        self.datefin.setAlignment(QtCore.Qt.AlignCenter)
        self.datefin.setObjectName("datefin")
        self.datedebut = QtWidgets.QLabel(self.demande)
        self.datedebut.setGeometry(QtCore.QRect(110, 50, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.frame_2.setGeometry(QtCore.QRect(380, 20, 241, 181))
        self.frame_2.setStyleSheet("background-color: rgb(132, 132, 132);")
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.label_7 = QtWidgets.QLabel(self.frame_2)
        self.label_7.setGeometry(QtCore.QRect(0, 10, 241, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(20, 122, 71, 41))
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(140, 120, 71, 41))
        ...
        self.label_8.setGeometry(QtCore.QRect(0, 50, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(0, 90, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_10.setGeometry(QtCore.QRect(110, 90, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_11.setGeometry(QtCore.QRect(110, 50, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "organigrame"))
        self.nomdemadeur.setText(_translate("MainWindow", "nom du demandeur"))
        self.label_3.setText(_translate("MainWindow", "date debut : "))
        self.refuser.setText(_translate("MainWindow", "date fin    :"))
        self.datefin.setText(_translate("MainWindow", "11/11/2011"))
        self.datedebut.setText(_translate("MainWindow", "01/01/2010"))
        self.label_7.setText(_translate("MainWindow", "nom du demandeur"))
        self.label_8.setText(_translate("MainWindow", "date debut : "))
        self.label_9.setText(_translate("MainWindow", "date fin    :"))
        self.label_10.setText(_translate("MainWindow", "11/11/2011"))
        self.label_11.setText(_translate("MainWindow", "01/01/2010"))
